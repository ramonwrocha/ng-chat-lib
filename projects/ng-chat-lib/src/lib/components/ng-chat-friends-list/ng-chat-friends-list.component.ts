...
@Component({
  selector: 'lib-ng-chat-friends-list',
...
export class NgChatFriendsListComponent implements OnChanges {
  ...
  isUserSelectedFromFriendsList(user: User | any): boolean {
  ...
  onFriendsListCheckboxChange(selectedUser: User | any, event: any): void {
  ...
  onUserClick(clickedUser: User | any): void {
