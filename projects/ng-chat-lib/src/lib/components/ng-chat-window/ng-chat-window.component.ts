...
export class NgChatWindowComponent {
  ...
  defaultWindowOptions(currentWindow: Window | any): IChatOption[]
  {
  ...
  isAvatarVisible(window: Window, message: Message | any, index: number): boolean
  {
  ...
  getChatWindowAvatar(participant: IChatParticipant | any, message: Message): string | null | any
  {
  ...
  activeOptionTrackerChange(option: IChatOption | any): void {
